...
import { 
  ...
  ArrowUpRight, ArrowDownRight, Bell, User, ChevronRight
} from 'lucide-react';
import { 
...
const ClientHome = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await axios.get(`${API}/client/summary`, { headers });
      setSummary(res.data);
    } catch (err) {
      console.error(err);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-[3rem] p-8 border border-slate-100 shadow-sm flex flex-col">
          <div className="flex items-center justify-between mb-8 px-4">
            ...
            <Link to="/client/history" className="text-xs font-black text-indigo-600 uppercase tracking-widest flex items-center gap-1 hover:underline">
